package net.dnadas.companies.controller.exceptionhandler;

import net.dnadas.auth.exception.account.AccountAlreadyExistsException;
import net.dnadas.auth.exception.account.AccountLinkingRequiredException;
import net.dnadas.auth.exception.account.AccountNotFound;
import net.dnadas.auth.exception.account.OnlyOneAccountFoundException;
...
import net.dnadas.auth.exception.verification.VerificationTokenAlreadyExistsException;
...
import net.dnadas.companies.exception.company.project.task.expense.ExpenseNotFoundException;
