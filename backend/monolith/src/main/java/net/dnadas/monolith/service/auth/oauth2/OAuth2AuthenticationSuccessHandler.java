package net.dnadas.monolith.service.auth.oauth2;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lombok.RequiredArgsConstructor;
import net.dnadas.monolith.dto.auth.TokenPayloadDto;
import net.dnadas.monolith.exception.auth.OAuth2ProcessingException;
import net.dnadas.monolith.model.auth.account.OAuth2UserAccount;
