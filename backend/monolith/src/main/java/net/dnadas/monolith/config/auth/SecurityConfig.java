package net.dnadas.monolith.config.auth;

import lombok.RequiredArgsConstructor;
import net.dnadas.monolith.filter.auth.JwtAuthenticationFilter;
import net.dnadas.monolith.model.auth.OAuth2AuthorizationRequestDao;
...
import net.dnadas.monolith.service.auth.CookieService;
import net.dnadas.monolith.service.auth.CustomPermissionEvaluator;
import net.dnadas.monolith.service.auth.RefreshService;
import net.dnadas.monolith.service.auth.oauth2.DatabaseOAuth2AuthorizationRequestService;
import net.dnadas.monolith.service.auth.oauth2.OAuth2AuthenticationFailureHandler;
import net.dnadas.monolith.service.auth.oauth2.OAuth2AuthenticationSuccessHandler;
import net.dnadas.monolith.service.auth.oauth2.OAuth2UserAccountService;
